...
export const g03Fill: GrammarFillQuestion[] = [
  ...
  { id: 'g03f30', grammarId: 'G03', sentence: 'It ____ (snow) in winter.', options: ['snows', 'is snowing', 'snow'], answer: 'is snowing', explanation: 'Look! / Listen! 等提示词用现在进行时。' },
];
...
export const g09Fill: GrammarFillQuestion[] = [
  ...
  { id: 'g09f16', grammarId: 'G09', sentence: 'He is ____ (far) I have ever run.', options: ['farthest', 'the farthes', 'farther'], answer: 'the farthes', explanation: 'far 的最高级是 farthes。' },
...
export const g16Fill: GrammarFillQuestion[] = [
  ...
  { id: 'g16f07', grammarId: 'G16', sentence: '____ he ____ (be) at home?', options: ['Is / he', 'Does / he', 'Do / he'], answer: 'Is / he', explanation: 'be 动词疑问句提前。' },
  ...
  { id: 'g16f15', grammarId: 'G16', sentence: '____ you ____ (can) swim?', options: ['Do / can', 'Can / you', 'Are / can'], answer: 'Can / you', explanation: '情态动词疑问句提前。' },
  ...
  { id: 'g16f17', grammarId: 'G16', sentence: '____ she ____ (will) come?', options: ['Will / she', 'Does / will', 'Is / will'], answer: 'Will / she', explanation: 'will 疑问句提前。' },
  ...
  { id: 'g16f19', grammarId: 'G16', sentence: '____ they ____ (should) go?', options: ['Should / they', 'Do / should', 'Are / should'], answer: 'Should / they', explanation: 'should 疑问句提前。' },
  ...
  { id: 'g16f21', grammarId: 'G16', sentence: '____ he ____ (must) go?', options: ['Must / he', 'Does / must', 'Is / must'], answer: 'Must / he', explanation: 'must 疑问句提前。' },
  ...
  { id: 'g16f23', grammarId: 'G16', sentence: '____ you ____ (be) at home?', options: ['Are / you', 'Do / are', 'Is / you'], answer: 'Are / you', explanation: 'be 动词疑问句提前。' },
...
export const g18Correction: GrammarCorrectionQuestion[] = [
  ...
  { id: 'g18x08', grammarId: 'G18', sentence: "Turn on the TV, please.", answer: "Turn off the TV, please.", explanation: '这里应该用 turn off（关闭），除非是要打开。' },
  { id: 'g18x09', grammarId: 'G18', sentence: 'She looks after her mother.', answer: 'She looks like her mother.', explanation: 'look like 表示看起来像，look after 表示照顾。' },
